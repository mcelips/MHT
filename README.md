...
* Имя файлов, которые относятся к базовому функционалу, вначале добавлять нижнее подчеркивание. Это позволит сразу
  ...
  файлов: `_config.php`, `_errors.php` и т.д. Или можно добавить подчеркивание в конце файла: `_config_.php`.
* Не использовать в имени файлов стиль CamelCase, слова <u>разделять нижним подчеркиванием</u>:
  Например, <s style="color:#f03c15;">getAllPlanets.php</s> - неверно, <t style="color:#15f015;">get_all_planets.php</t> - верно.
